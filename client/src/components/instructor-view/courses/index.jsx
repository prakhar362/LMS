    ...
    >
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 rounded-3xl border border-slate-200 shadow-xl shadow-slate-100/50">
         <div className="flex items-center space-x-4">
            <div className="h-12 w-12 bg-indigo-50 rounded-2xl flex items-center justify-center text-indigo-600 border border-indigo-100 shadow-sm">
               <BookText className="h-6 w-6" />
            </div>
            <div>
               <h2 className="text-2xl font-black text-slate-900 tracking-tight font-outfit uppercase">Manifested Modules</h2>
         ...
         <div className="flex items-center space-x-3">
            ...
            <Button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-black px-6 h-12 rounded-2xl shadow-xl shadow-indigo-100 transition-all hover:scale-[1.02] active:scale-95 flex items-center space-x-2"
            >
      ...
      <Card className="border-none shadow-2xl shadow-slate-200/60 bg-white ring-1 ring-slate-200 overflow-hidden">
        <CardHeader className="bg-slate-50/50 border-b border-slate-200 py-6 px-8 flex flex-row items-center justify-between">
           <div>
              <CardTitle className="text-xl font-black font-outfit text-slate-900 tracking-tight">Active Course Ledger</CardTitle>
                    ...
                    <TableRow key={course._id} className="group border-slate-50 hover:bg-slate-50/50 transition-all">
                      <TableCell className="py-6 pl-10">
                         <div className="flex flex-col">
                            <span className="font-black text-slate-900 tracking-tight leading-none mb-1 group-hover:text-indigo-600 transition-colors uppercase">{course?.title}</span>
                      ...
                      <TableCell className="py-6 pr-10 text-right">
                         <div className="flex items-center justify-end space-x-2">
                            <Button
                              ...
                              variant="ghost"
                              className="h-9 w-9 p-0 rounded-xl hover:bg-indigo-50 hover:text-indigo-600 flex items-center justify-center transition-colors"
                            >
        ...
        {listOfCourses && listOfCourses.length === 0 && (
           <div className="py-24 text-center bg-white flex flex-col items-center">
              ...
              <p className="text-slate-400 font-black uppercase text-xs tracking-[0.3em] font-outfit">Module Inventory Empty</p>
           </div>
        )}
      </Card>
    </motion.div>
